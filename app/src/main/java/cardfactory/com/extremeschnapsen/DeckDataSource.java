...
public class DeckDataSource {
    ...
    public Deck createDeck(String cardSuit, String cardRank, int cardValue, int deckStatus, int deckTrump) {
    ...
    private Deck cursorToDeck(Cursor cursor) {
        ...
        Deck deck = new Deck(id, deckSuit, deckRank, deckValue, deckStatus, deckTrump);
    ...
    public List<Deck> getAllDeck() {
        ...
        while(!cursor.isAfterLast()) {
            ...
            deckList.add(deck);
            Log.d(LOG_TAG, "ID: " + deck.getCardID() + ", Inhalt: " + deck.toString());
            cursor.moveToNext();
        }
