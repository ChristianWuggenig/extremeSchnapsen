...
public class MessageHelper {
    ...
    public static final String TWENTYRECEIVED = "20received";
    ...
    public static final String TURNEDCALLEDSUCESS = "turnedCalledSuccess";
    public static final String TURNEDCALLEDFAIL = "turnedCalledFail";
    public static final String TURNEDRECEIVED = "turnedReceived";
}
